...
Original file is located at
    https://colab.research.google.com/drive/1--NUjZ9B9jidPXsnP76UY93Zk_e0E4YK
...
import pandas as pd
# 로컬의 데이터 파일을 활용
dataset_json = dataset_json = load_dataset("json", data_files="/content/drive/MyDrive/git/3-huggingface/review_신라스테이 해운대.json")
print(dataset_json)
...
klue_tc_eval_removed = klue_tc_train.remove_columns(['guid', 'url', 'date'])
...
klue_tc_eval_removed = klue_tc_train_removed.map(make_str_label, batched=True, batch_size=1000)
